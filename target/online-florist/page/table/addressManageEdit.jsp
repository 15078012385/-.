    ...
    <div class="layui-form layuimini-form" lay-filter="editForm">
        <div class="layui-form-item" style="display: none;">
            ...
            <div class="layui-input-block">
                <input type="number" name="id" lay-verify="required" lay-reqtext="用户ID不能为空" placeholder="请输入用户ID"
        ...
        <!-- <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="recipientName" lay-verify="required" lay-reqtext="收件人姓名不能为空"
    ...
    <script>
        layui.use(['form'], function () {
            ...
            form.on('submit(saveBtn)', function (data) {
                $.ajax({
                    type: "post",
                    url: "http://localhost:8080/api/address?operation=update&id=" + data.field.id + "&recipientName=***"  + "&address=" + data.field.address + "&phone=" + data.field.phone + "&userId=0" ,
